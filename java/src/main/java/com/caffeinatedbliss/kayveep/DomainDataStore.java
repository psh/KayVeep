...
public class DomainDataStore<T extends StorableObject> {
	...
	private RawDataStore rawData;
	private ObjectStore<T> data;
	private DataStore meta;
	private TimestampDataStore created;
	private TimestampDataStore updated;
	...
	private static List<String> extractRawFieldsFromTarget(Class type, String[] raw) {
		List<String> theRawFields = (raw != null) ? new ArrayList<String>(Arrays.asList(raw)) : new ArrayList<String>();
